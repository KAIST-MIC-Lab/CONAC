...
Since, here, the control input constraints are inactive, $\sat(\cdot)$ in \eqref{eq:lya1:dot2} and $c_j,\ \forall j\in\mathcal{I}$ in \eqref{eq:lya2:dot} can be removed.
...
\dot {\estwth}= \text{Proj}_{\Omega}[\alpha  (\partial \estNN/\partial \estwth)M_0^{-1}{\tilde z}],
\end{equation}
