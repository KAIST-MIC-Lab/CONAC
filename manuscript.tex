...
This study extends our preliminary works in \cite{Ryu:2024aa,Ryu:2025aa}, where inequality constraints on the weight and input norm were introduced within a constrained optimization framework to ensure boundedness of the NN weights and satisfy input norm saturation, respectively. 
In addition to the weight and input norm constraints considered in \cite{Ryu:2024aa,Ryu:2025aa}, the present work also incorporates any convex input constraints into the same framework to address the convex input saturation problem. 
