...
\MSRY{
    As discussed in Section \ref{sec:intro}, the boundedness of the weights should be addressed to prevent excessively large control inputs and system instability.
}
