...
try:
    ...
    \\begin{{document}}
    \\input{{src/script_simulation/figures/compare/Fig{i}.tex}}
    \\end{{document}}
            """
        ...
        os.system(f"mv {tmp_file_name}-figure0.pdf fig/Fig{i}.pdf")
        print(f"PDF file fig/Fig{i}.pdf created successfully.")
