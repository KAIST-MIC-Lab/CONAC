...
c1_x1 =     transpose(data(ep_idx,[3,4]));
c1_x2 =     transpose(data(ep_idx,[5,6]));
c1_xd1 =    transpose(data(ep_idx,[7,8]));
c1_xd2 =    transpose(data(ep_idx,[9,10]));
c1_u =      transpose(data(ep_idx,[11,12]));
c1_uSat =   transpose(data(ep_idx,[13,14]));
c1_lbd =    transpose(data(ep_idx,15:22));
c1_th =     transpose(data(ep_idx,23:25));
c1_zeta =   transpose(data(ep_idx,26:27));
c1_cmp =    transpose(data(ep_idx,28));
...
plot(t1(obs_t1), c1_zeta(1,obs_t1), "Color", "cyan", "LineWidth", line_width, "LineStyle", "-", "DisplayName", "$\zeta_1$"); hold on
