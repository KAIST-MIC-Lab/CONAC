...
if SIM
    ...
    dataSet{1} = loadFromMeas(data_path_1+"/"+data_path_1+".mat", 4);
    dataSet{2} = loadFromMeas(data_path_2+"/"+data_path_2+".mat", 3);
    dataSet{3} = loadFromMeas(data_path_3+"/"+data_path_3+".mat", 2);
    dataSet{4} = loadFromMeas(data_path_4+"/"+data_path_4+".mat", 1);
