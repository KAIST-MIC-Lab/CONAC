...
\begin{revresponse}[]
  ...
  We took this overall concern seriously and undertook a comprehensive revision of the manuscript, as summarized in the overview of major changes below.
  ...
  \begin{enumerate}
    \item \textbf{Title and contribution clarification:} 
      The main contributions of the paper have been clarified as multiple convex input constraints instead of weight and input constraints.
      Target system is generalized from unknown Euler-Lagrange systems to unknown systems.
    \item \textbf{Literature review and comparison:} 
      We have added a more detailed literature review and comparison with existing methods to highlight the novelty and significance of our proposed approach.
...
\begin{revresponse}
  ...
  However, we acknowledge that, over the previous stated contribution, the significance of the proposed method is to incorporate multiple convex input constraints into the neuro-adaptive control framework, which typically only considers the element-wise input constraints.
  We provide a comparative illustration of the typical element-wise input constraints and the proposed multiple convex input constraints in Fig.~1 of the revised manuscript, as shown below.

  \begin{figure}[t]
    \centering
    \includegraphics[width=0.85\linewidth]{figs/r1c1_1.png}
  \end{figure}
...
% 
% LICQ 조건 엄밀한 증명
% DNN gradient derivation 엄밀한 증명
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
\begin{revcomment}[2]{}
...
\begin{howtoanswer}
	As we recognized the unclear and confusing notation in the previous manuscript, we have revised the notation and added a more detailed explanation of the weight adaptation law in Section~IV of the revised manuscript.
  For example, 
...
\begin{revresponse}
  ...
  The assumptions in the revised manuscript reflect the necessary conditions for the system, and located in Section~II, while the preliminaries regarding DNN features are provided in Section~III.A.
  All required lemmas for the stability analysis are presented in Section~IV with the corresponding proofs.
...
\begin{revresponse}
  ...
  In the revised manuscript, we have made a more concise and focused statement of the contributions.
